import { resolveSlug, loadProgramAssets, setApiUrl } from './loader.js';
import { PawFunction } from './runtime.js';
 ...
 * ```
 */
async function loadFunction(slugOrId, opts = {}) {
    ...
    const callable = ((input, maxTokens) => pawFn.run(input, maxTokens));
